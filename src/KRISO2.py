...
class KRISO:
    ...
    def frm_info_publish(self, ship_ID, Pos_X, Pos_Y, vel, psi_deg, delta_deg, r_deg, Drift_angle, start_time):
        ...
        kriso.m_fltFOGang_yawz = r_deg
        kriso.m_fltDriftangle = Drift_angle
...
def main():    
    ...
    for shipName in shipsInfo.shipName_all:
        ...
        shipState_all[shipName]["Drift_angle"] = 0.0
        shipState_all[shipName]["u"] = shipState_all[shipName]["U"]*cos(shipState_all[shipName]["Drift_angle"])
        shipState_all[shipName]["v"] = shipState_all[shipName]["U"]*sin(shipState_all[shipName]["Drift_angle"])
        shipState_all[shipName]["psi_deg"] = rospy.get_param(paramStr_initStartPsi)
        shipState_all[shipName]["delta_deg"] = 0.0
        shipState_all[shipName]["r_deg"] = 0.0
    ...
    while not rospy.is_shutdown():  
        ...
        r_deg_all = [shipState_all[shipName]['r_deg'] for shipName in shipsInfo.shipName_all]
        Drift_angle_all = [shipState_all[shipName]['Drift_angle'] for shipName in shipsInfo.shipName_all]
